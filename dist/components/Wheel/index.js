...
export var Wheel = function (_a) {
    ...
    var _w = useState(__spreadArray([], data, true)), wheelData = _w[0], setWheelData = _w[1];
    var _x = useState([[0]]), prizeMap = _x[0], setPrizeMap = _x[1];
    var _y = useState(0), startRotationDegrees = _y[0], setStartRotationDegrees = _y[1];
    var _z = useState(0), finalRotationDegrees = _z[0], setFinalRotationDegrees = _z[1];
    var _0 = useState(false), hasStartedSpinning = _0[0], setHasStartedSpinning = _0[1];
    var _1 = useState(false), hasStoppedSpinning = _1[0], setHasStoppedSpinning = _1[1];
    var _2 = useState(false), isCurrentlySpinning = _2[0], setIsCurrentlySpinning = _2[1];
    var _3 = useState(false), isDataUpdated = _3[0], setIsDataUpdated = _3[1];
    var _4 = useState(false), rouletteUpdater = _4[0], setRouletteUpdater = _4[1];
    var _5 = useState(0), loadedImagesCounter = _5[0], setLoadedImagesCounter = _5[1];
    var _6 = useState(0), totalImages = _6[0], setTotalImages = _6[1];
    var _7 = useState(false), isFontLoaded = _7[0], setIsFontLoaded = _7[1];
