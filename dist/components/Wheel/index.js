...
export var Wheel = function (_a) {
    ...
    return (React.createElement(RouletteContainer, { style: !isFontLoaded ? { visibility: 'hidden' } : {} },
        ...
        React.createElement(RouletteSelectorImage, { style: selectorProps === null || selectorProps === void 0 ? void 0 : selectorProps.style, src: (selectorProps === null || selectorProps === void 0 ? void 0 : selectorProps.src) || rouletteSelector.src, alt: "roulette-static" })));
};
