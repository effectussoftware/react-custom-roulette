...
export var Wheel = function (_a) {
    ...
    var START_SPINNING_TIME = 2600 * rotationTimeCoefficient;
    var CONTINUE_SPINNING_TIME = 750 * rotationTimeCoefficient;
    var STOP_SPINNING_TIME = 8000 * rotationTimeCoefficient;
    ...
    return (React.createElement(RouletteContainer, null,
        React.createElement(RotationContainer, { className: getRouletteClass(), startSpinningTime: START_SPINNING_TIME, continueSpinningTime: CONTINUE_SPINNING_TIME, rotationTimeCoefficient: rotationTimeCoefficient, stopSpinningTime: STOP_SPINNING_TIME, startRotationDegrees: startRotationDegrees, finalRotationDegrees: finalRotationDegrees },
